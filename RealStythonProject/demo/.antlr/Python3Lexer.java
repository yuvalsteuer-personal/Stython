// Generated from /home/yuvalsteuer/Desktop/RealStythonProject/demo/Python3.g4 by ANTLR 4.7.1
...
public class Python3Lexer extends Lexer {
	...
	public Vocabulary getVocabulary() {
	  ...
	  public:
		virtual void emit(std::unique_ptr<antlr4::Token> newToken) override
		{
			...
			tokens.push_back(std::move(antlr4::Lexer::token));
		}
	...
	private void NEWLINE_action(RuleContext _localctx, int actionIndex) {
		...
		case 0:
				...
				{
					std::regex reg1 = std::regex(R"reg([^\r\n\f]+)reg");
					std::regex reg2 = std::regex(R"reg([\r\n\f]+)reg");
					std::string newLine = std::regex_replace(antlr4::Lexer::getText(),reg1, "");
					std::string spaces = std::regex_replace(antlr4::Lexer::getText(),reg2, "");
					int next = antlr4::Lexer::_input->LA(1);
					...
					{
						this->emit(std::unique_ptr<antlr4::Token>(dynamic_cast<antlr4::Token*>(commonToken(NEWLINE, newLine)))); //might be
						...
						{
							indents.push(indent);
							antlr4::Lexer::emit(std::unique_ptr<antlr4::Token>(dynamic_cast<antlr4::Token*>(commonToken(antlrcpptest::Python3Parser::INDENT, spaces)))); // might be Lexer::emit
						}
						else
						{
							...
							{
								this->emit(std::move(createDedent()));
								indents.pop();
							}
						}
					}
